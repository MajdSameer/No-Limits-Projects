 ...
 * /api/version and /sounds (the wall display's celebration audio) are
...
export const config = {
  matcher: [
    "/((?!sign-in|tv|live|actions|api/boards|api/actions|api/version|api/cron|api/ingest|sounds|_next/static|_next/image|favicon.ico|icon.svg|robots.txt).*)",
  ],
};
